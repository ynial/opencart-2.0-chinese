...
$_['help_keyword']      = '不要用空格分隔多个关键字，用-分隔，请保持关键词的全局唯一性.';
$_['help_sku']      = '库存单位';
$_['help_upc']      = '通用商品代码';
$_['help_ean']      = '欧洲商品编码';
$_['help_jan']      = '日本商品编码';
$_['help_isbn']      = '国际标准图书编码';
$_['help_mpn']      = '品牌商家编码';
$_['help_manufacturer']      = '(自动完成)';
$_['help_minimum']      = '最小起订量';
$_['help_stock_status']      = '缺货时显示的缺货状态';
$_['help_points']      = '购买该商品时可以使用的积分，如果不希望使用积分直接写0';
$_['help_category']      = '(自动完成)';
$_['help_filter']      = '(自动完成)';
$_['help_download']      = '(自动完成)';
$_['help_related']      = '(自动完成)';
$_['help_tag']      = '如果多个，使用逗号分隔';
$_['error_warning']      = '警告： 相关数据未键入！';
$_['error_permission']      = '警告： 您没有权限更改产品！';
$_['error_name']      = '商品名称长度必须在3至255个字符之间！';
$_['error_meta_title']      = 'Meta 标题必须在3~255字符之间!';
